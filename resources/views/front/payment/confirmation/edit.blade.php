	...
	<div class="row">
		<div class="col-sm-12">
			<div class="box box-solid">
				<div class="box-body">
					<form method="post" action="{{ url('payment-confirmation/'.$paymentConfirmation->id) }}"
						...
						<div class="row">
							<div class="col-sm-6">
								...
								{{ $errors->has('transfer_date') ? 'has-error' : '' }}">
									...
									<input type="text" name="transfer_date" value="{{ $paymentConfirmation->dateFormatted() }}" 
								...
								{{ $errors->has('user_bank_name') ? 'has-error' : '' }}">
									...
									<input type="text" name="user_bank_name" value="{{ $paymentConfirmation->user_bank_name }}" 
							...
							<div class="col-sm-6">
								...
								{{ $errors->has('bank_account') ? 'has-error' : '' }}">
									...
									<input type="text" name="bank_account" value="{{ $paymentConfirmation->bank_account }}" 
								...
								{{ $errors->has('under_the_name') ? 'has-error' : '' }}">
									...
									<input type="text" name="under_the_name" value="{{ $paymentConfirmation->under_the_name }}"
									class="form-control" autocomplete="off">
								...
								{{ $errors->has('amount') ? 'has-error' : '' }}">
									...
									<input type="text" name="amount" value="{{ $paymentConfirmation->amount }}" 
									class="form-control" autocomplete="off">
